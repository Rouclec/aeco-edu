...
const PartnerCard: FC = () => {
  return (
    <div className="grid self-center shadow-lg border-[1px] hover:-translate-y-1 hover:shodow-sm hover:shadow-[var(--secondary-300)] hover:cursor-pointer transition-all duration-500">
      <div className="flex border-b-2 p-4 pt-6 gap-2 items-center w-full">
        <Image
